...
# Get Job Recommendations: Student Only 
@router.get("/")
def get_recommendations(current_user: dict = Depends(get_current_student)):
    ...
    try:
        # Check 1: student must have skills extracted from resume
        cur.execute(
        ...
        # Check 2: student must have a resume with experience info
        cur.execute(
        ...
        # Check 3: call Agent 3 (Generate_Job_Recommendations procedure)
